...
export default {
  ...
  mounted() {
    this.$refs.canvas.createTriangle({
      id: 'Triangle', x: 100, y: 100, x1: 150, y1: 200, x2: 180, y2: 190, fill: 'yellow', left: 80
    });
    this.$refs.canvas.createImage('/images/sticker1.png', {
      id: 'myImage', width: 100, height: 100, left: 110, top: 110
    });
    ...
    this.$refs.canvas.createTextbox('Hello!', { top: 100, left: 300 });
